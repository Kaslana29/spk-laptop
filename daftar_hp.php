...
<?php 
	if(isset($_POST["tambah_hp"])){
		...
		if($processor == "Core i5"){
			$processor_angka = 1;
		}
		elseif($processor == "Core i7"){
			$processor_angka = 3;
		}
		elseif($processor == "Core i9"){
			$processor_angka = 5;
		}
    	...
    	<div class="container">
						...
						<div class="nav-wrapper">
								<ul class="left" style="margin-left: -52px;">
									...
									<li><a class="active" href="daftar_hp.php">DAFTAR LAPTOP</a></li>
									...
									<table id="table_id" class="hover dataTablesCustom" style="width:100%">
											<thead style="border-top: 1px solid #d0d0d0;">
												<tr>
													...
													<th><center>Layar Laptop</center></th>
											...
											<tbody>
												...
												<tr>
													...
													<td><center><?php echo $data['kamera_hp']," Inch" ?></center></td>
													<td>
														<center>
															<form method="POST">
									...
									<div class="col s12">
										...
										<div class="col s6">
											<select style="display: block; margin-bottom: 4px;" required name="kamera">
												...
												<option value = "8">13 Inch</option>
												<option value = "13">14 Inch</option>
												<option value = "16">15 Inch</option>
											</select>
										</div>
