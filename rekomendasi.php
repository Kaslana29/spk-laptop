...
<body>
	...
	<div id="about" class="modal">
        <div class="modal-content">
          <h4>Tentang</h4>
          <p>Sistem Pengambilan Keputusan Laptop ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP.
