...
<html>
<head>
	<title>Sistem Pengambilan Keputusan Laptop</title>
...
<body>
    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container">
			<div class="section no-pad-bot">
				<div class="container">
					<h1 class="header jarak center white-text" style="font-size: 40px">SISTEM PENGAMBILAN KEPUTUSAN</h1>
			...
			<div class="parallax"><img src="assets/image/rog.jpg" alt="Laptop"></div>
		</div>
		<!-- Jumbotron End -->
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pengambilan Keputusan Laptop ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Tugas Project Capstone Studi Independen Bersertifikat di PT Techno International Mandira.</p>
						</div>
			    	<div class="col s6">
    ...
    <div class="modal-content">
	  ...
	  Sistem ini dibuat sebagai Tugas Project Capstone Team 19 :<br>
				<br>
					1. Anisa Qolbiah Mutmainah<br>
					2. Atika Syuhriana A<br>
					3. Gilang Rusdyansya Putra<br>
					4. Jhony Irwan Saputra<br>
					5. Muhammad Anshori<br>
					6. Muhammad Nailul Farizqi<br> 
					7. Oktavia Shantika Dewi<br> 
					8. Tegar Arif Wibowo<br>
			</p>
    </div>
	...
	<div class="footer-copyright" style="padding: 0px 0px">
      <div class="container">
        <p align="center" style="color: #999">&copy; Sistem Pengambilan Keputusan Laptop Team 19.</p>
      </div>
    </div>
    <!-- Footer End -->
